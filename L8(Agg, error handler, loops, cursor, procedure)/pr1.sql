...
gender enum('m','f'),
prog_lang set('java','python','django','golang')
);

insert into student values(default, 'amit', 90, default, 'm', 'java'), (default, 'seema', 40, 'thane', 'f', 'java'),(default, 'raj', 60, default, 'm', 'java'),(default, 'reema', 70, 'thane', 'f', 'python'),
